...
export default function TypingToolbar({ dictId, currentChapterId, chapters, config, toggleConfig, updateConfig, darkMode, toggleDarkMode, onOpenWrongBook }) {
  ...
  const toolbarBtn = "p-2 rounded-button hover:bg-primary/5 dark:hover:bg-white/[0.05] transition-colors text-content-secondary dark:text-gray-400 flex flex-col items-center gap-1";
