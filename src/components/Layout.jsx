...
function Layout() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-background-dark transition-colors duration-500 relative">
      <StarryBackground />
      <nav className="h-16 glass-card border-b border-gray-200/80 dark:border-white/[0.06] flex items-center justify-between px-6 sticky top-0 z-50 nav-glow transition-shadow duration-500">
