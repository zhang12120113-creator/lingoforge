...
export default function ChapterSelect() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-transparent p-6 transition-colors duration-500 animate-page-fade-in">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => { sessionStorage.setItem(RESTORE_KEY, 'true'); navigate('/word'); }} className="text-content-tertiary dark:text-gray-400 hover:text-primary dark:hover:text-primary-dark mb-8 flex items-center gap-2 text-sm transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/[0.04] w-fit">
